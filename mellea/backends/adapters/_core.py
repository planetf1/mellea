...
Also provides :class:`LocalFileBinding`, :class:`EmbeddedBinding` (Embedded/
Granite Switch — `apply_activation`, no weights lifecycle), a stub
:class:`WeightsBinding` subclass (:class:`ServerMediatedBinding`), and
